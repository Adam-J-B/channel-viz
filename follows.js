(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'if6ZLeJpOxSsrEwIeXZduhFOapgq19NH1dUth6bBp0o0e7pF', // Unique master Xively API key to be used as a default
		defaultFeeds	= [916945674], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'WX Station - Adam Burns - Urbana, IL', // Replaces Xively logo in the header
		...
		dataColor		= '250A4A', // CSS HEX value of color to represent data (omit leading #)
